...
class CardSekolahAdapter(private val listSekolah: ArrayList<Sekolah>) : RecyclerView.Adapter<CardSekolahAdapter.CardViewHolder>() {
    inner class CardViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        var tvKabupaten: TextView = itemView.findViewById(R.id.tv_kabupaten)
        var tvProvinsi: TextView = itemView.findViewById(R.id.tv_provinsi)
    ...
    override fun onBindViewHolder(holder: CardSekolahAdapter.CardViewHolder, position: Int) {
        ...
        holder.tvKabupaten.text = sekolah.kabupaten
        holder.tvProvinsi.text = sekolah.provinsi
